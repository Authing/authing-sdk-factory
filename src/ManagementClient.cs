...
namespace Authing.SDK.V3.Services
{
    ...
    public async Task<PrincipalAuthenticationInfoPaginatedRespDto> GetPrincipalAuthenticationInfo(string userId)
    {
    ...
    public async Task<IsSuccessRespDto> ResetPrincipalAuthenticationInfo( ResetUserPrincipalAuthenticationInfoDto requestBody
)
{
...
/// <param name="requestBody"></param>
///<returns>IsSuccessRespDto</returns>
public async Task<IsSuccessRespDto> DeleteUserBatch( DeleteUsersBatchDto requestBody
)
{
...
public async Task<IsUserExistsRespDto> KickUsers( KickUsersDto requestBody
)
{
...
/// <param name="limit">每页数目，最大不能超过 50，默认为 10</param>
///<returns>GroupPaginatedRespDto</returns>
public async Task<GroupPaginatedRespDto> GetGroupList(long page=1,long limit=10)
{
...
public async Task<GroupListRespDto> CreateGroupBatch( CreateGroupBatchReqDto requestBody
)
{
...
/// <param name="requestBody"></param>
///<returns>IsSuccessRespDto</returns>
public async Task<IsSuccessRespDto> DeleteGroups( DeleteGroupsReqDto requestBody
)
{
...
public async Task<OrganizationPaginatedRespDto> ListOrganizations(long page=1,long limit=10)
{
...
/// <param name="withDepartmentIds">是否获取部门 ID 列表</param>
///<returns>UserListRespDto</returns>
public async Task<UserListRespDto> ListDepartmentMembers(string departmentId,string organizationCode,string departmentIdType="department_id",long page=1,long limit=10,bool withCustomData=false,bool withIdentities=false,bool withDepartmentIds=false)
{
...
/// <param name="nameSpace">所属权限分组的 code，当 target_type 为角色的时候需要填写，否则可以忽略。</param>
...
public async Task<ResourceDto> CreateNamespace( CreateNamespaceDto requestBody
)
{
    string httpResponse=await Request("POST", "/api/v3/create-namespace",requestBody).ConfigureAwait(false);
    ResourceDto result=m_JsonService.DeserializeObject<ResourceDto>(httpResponse);
    return result;
}
///<summary>
/// 批量创建权限分组
...
///<returns>IsSuccessRespDto</returns>
public async Task<IsSuccessRespDto> GetTargetAuthorizedResources(string targetIdentifier,string targetType,string nameSpace=null,string resourceType=null)
{
