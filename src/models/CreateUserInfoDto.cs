...
namespace Authing.SDK.V3.Models
{
    ...
    public partial class CreateUserInfoDto
    {
        ...
        /// </summary>
        [JsonProperty("status")]
        public    CreateUserInfoDto.status   Status    {get;set;}
        /// <summary>
        ///  邮箱
        /// </summary>
        [JsonProperty("email")]
        ...
        public    CreateUserInfoDto.passwordEncryptType   PasswordEncryptType    {get;set;}
        /// <summary>
        ///  手机号
        /// </summary>
        [JsonProperty("phone")]
        ...
        /// </summary>
        [JsonProperty("gender")]
        public    CreateUserInfoDto.gender   Gender    {get;set;}
        /// <summary>
        ///  邮箱是否验证
        /// </summary>
