...
namespace Authing.SDK.V3.Models
{
    ...
    public partial class CreateUserReqDto
    {
        ...
        /// </summary>
        [JsonProperty("status")]
        public    CreateUserReqDto.status   Status    {get;set;}
        /// <summary>
        ///  邮箱
        /// </summary>
        [JsonProperty("email")]
        ...
        public    CreateUserReqDto.passwordEncryptType   PasswordEncryptType    {get;set;}
        /// <summary>
        ///  手机号
        /// </summary>
        [JsonProperty("phone")]
        ...
        /// </summary>
        [JsonProperty("gender")]
        public    CreateUserReqDto.gender   Gender    {get;set;}
        /// <summary>
        ///  邮箱是否验证
        /// </summary>
