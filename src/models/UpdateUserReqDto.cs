...
namespace Authing.SDK.V3.Models
{
    ...
    public partial class UpdateUserReqDto
    {
        ...
        /// </summary>
        [JsonProperty("status")]
        public    UpdateUserReqDto.status   Status    {get;set;}
        /// <summary>
        ///  邮箱是否验证
        /// </summary>
        ...
        /// </summary>
        [JsonProperty("gender")]
        public    UpdateUserReqDto.gender   Gender    {get;set;}
        /// <summary>
        ///  用户名，用户池内唯一
        /// </summary>
        ...
        public    UpdateUserReqDto.passwordEncryptType   PasswordEncryptType    {get;set;}
        /// <summary>
        ///  邮箱
        /// </summary>
        [JsonProperty("email")]
