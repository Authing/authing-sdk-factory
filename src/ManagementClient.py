...
class ManagementClient(object):
    ...
    def get_user(self, user_id=None, phone=None, email=None, username=None, external_id=None, options=None ):
        """获取用户信息
    ...
    def create_user(self, status=None, email=None, phone=None, phone_country_code=None, username=None, name=None, nickname=None, photo=None, gender=None, email_verified=None, phone_verified=None, external_id=None, department_ids=None, custom_data=None, password=None, tenant_ids=None, identities=None, options=None ):
        """创建用户
    ...
    def update_user(self, user_id, phone_country_code=None, name=None, nickname=None, photo=None, external_id=None, status=None, email_verified=None, phone_verified=None, gender=None, username=None, email=None, phone=None, password=None, custom_data=None ):
        """修改用户资料
    ...
    def get_user_login_history(self, user_id, app_id=None, client_ip=None, start=None, end=None, options=None ):
        """获取用户的登录历史记录
    ...
    def update_organization(self, organization_code, organization_new_code=None, organization_name=None ):
        """修改顶层组织机构
    ...
    def create_department(self, organization_code, name, parent_department_id, code=None, leader_user_id=None ):
        """创建部门
    ...
    def update_department(self, organization_code, name, parent_department_id, department_id, code=None, leader_user_id=None ):
        """修改部门
    ...
    def create_ext_idp_conn(self, fields, logo, identifier, type, ext_idp_id, display_name=None ):
        """在某个已有身份源下创建新连接
    ...
    def update_ext_idp_conn(self, login_only, association_mode, logo, fields, display_name, id, challenge_binding_methods=None ):
        """更新身份源连接
    ...
    def create_resource(self, actions, type, code, description=None, api_identifier=None, namespace=None ):
        """创建资源
    ...
    def update_resource(self, actions, type, code, description=None, api_identifier=None, namespace=None ):
        """修改资源
    ...
    def get_target_authorized_resources(self, target_identifier, target_type, namespace=None, resource_type=None ):
        """获取某个主体被授权的资源列表
