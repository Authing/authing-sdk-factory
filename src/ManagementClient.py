...
class ManagementClient(object):
    ...
    def update_user(self, phone_verified, email_verified, gender, user_id, phone_country_code=None, name=None, nickname=None, photo=None, external_id=None, custom_data=None, username=None, email=None, phone=None, password=None ):
        """修改用户资料
