...
class ManagementClient(object):
    ...
    def get_user(self, user_id, with_custom_data=None, with_identities=None, with_department_ids=None, phone=None, email=None, username=None, externalId=None ):
        """获取用户信息
    ...
    def get_user_batch(self, user_ids, with_custom_data=None, with_identities=None, with_department_ids=None ):
        """批量获取用户信息
    ...
    def list_users(self, page=None, limit=None, with_custom_data=None, with_identities=None, with_department_ids=None ):
        """获取用户列表
    ...
    def create_user(self, status=None, email=None, password_encrypt_type=None, phone=None, phone_country_code=None, username=None, name=None, nickname=None, photo=None, gender=None, email_verified=None, phone_verified=None, birthdate=None, country=None, province=None, city=None, address=None, street_address=None, postal_code=None, external_id=None, department_ids=None, custom_data=None, password=None, tenant_ids=None, identities=None, options=None ):
        """创建用户
    ...
    def update_user(self, user_id, phone_country_code=None, name=None, nickname=None, photo=None, external_id=None, status=None, email_verified=None, phone_verified=None, birthdate=None, country=None, province=None, city=None, address=None, street_address=None, postal_code=None, gender=None, username=None, password_encrypt_type=None, email=None, phone=None, password=None, custom_data=None ):
        """修改用户资料
    ...
    def get_user_login_history(self, user_id, app_id=None, client_ip=None, start=None, end=None, page=None, limit=None ):
        """获取用户的登录历史记录
    ...
    def get_user_authorized_resources(self, user_id, namespace=None, resource_type=None ):
        """获取用户被授权的所有资源
    ...
    def list_group_members(self, code, page=None, limit=None, with_custom_data=None, with_identities=None, with_department_ids=None ):
        """获取分组成员列表
    ...
    def list_role_members(self, code, page=None, limit=None, with_custom_data=None, with_identities=None, with_department_ids=None, namespace=None ):
        """获取角色成员列表
    ...
    def create_organization(self, organization_name, organization_code, open_department_id=None ):
        """创建顶层组织机构
    ...
    def update_organization(self, organization_code, open_department_id=None, organization_new_code=None, organization_name=None ):
        """修改顶层组织机构
    ...
    def create_department(self, organization_code, name, parent_department_id, open_department_id=None, code=None, leader_user_id=None, department_id_type=None ):
        """创建部门
    ...
    def update_department(self, organization_code, parent_department_id, department_id, code=None, leader_user_id=None, name=None, department_id_type=None ):
        """修改部门
    ...
    def delete_department(self, organization_code, department_id, department_id_type=None ):
        """删除部门
    ...
    def list_children_departments(self, department_id, organization_code, department_id_type=None ):
        """获取子部门列表
    ...
    def list_department_members(self, organization_code, department_id, department_id_type=None, page=None, limit=None, with_custom_data=None, with_identities=None, with_department_ids=None ):
        """获取部门直属成员列表
    ...
    def list_department_member_ids(self, organization_code, department_id, department_id_type=None ):
        """获取部门直属成员 ID 列表
    ...
    def get_parent_department(self, organization_code, department_id, department_id_type=None ):
        """获取父部门信息
    ...
    def create_ext_idp_conn(self, fields, display_name, identifier, type, ext_idp_id, login_only=None, logo=None ):
        """在某个已有身份源下创建新连接
    ...
    def create_resource(self, type, code, description=None, actions=None, api_identifier=None, namespace=None ):
        """创建资源
    ...
    def update_resource(self, code, description=None, actions=None, api_identifier=None, namespace=None, type=None ):
        """修改资源
    ...
    def get_target_authorized_resources(self, target_type, target_identifier, namespace=None, resource_type=None ):
        """获取某个主体被授权的资源列表
