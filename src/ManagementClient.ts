 ...
 */
public async resetPrincipalAuthenticationInfo(requestBody: ResetUserPrincipalAuthenticationInfoDto,
 ...
 * @returns IsSuccessRespDto
 */
public async deleteUserBatch(requestBody: DeleteUsersBatchDto,
): Promise<IsSuccessRespDto> {
    return await this.httpClient.request({
        method: 'POST',
 ...
 */
public async createGroupBatch(requestBody: CreateGroupBatchReqDto,
 ...
 * @returns IsSuccessRespDto
 */
public async deleteGroups(requestBody: DeleteGroupsReqDto,
): Promise<IsSuccessRespDto> {
    return await this.httpClient.request({
        method: 'POST',
 ...
 * @returns IsSuccessRespDto
 */
public async assignRoleBatch(requestBody: AssignRoleBatchDto,
): Promise<IsSuccessRespDto> {
    return await this.httpClient.request({
        method: 'POST',
 ...
 * @returns IsSuccessRespDto
 */
public async revokeRoleBatch(requestBody: RevokeRoleBatchDto,
): Promise<IsSuccessRespDto> {
    return await this.httpClient.request({
        method: 'POST',
